...
//   // Handle Payment CTA Route
//   const handlePaymentClick = (bookingId: string) => {
//     router.push(`/dashboard/sender/checkout/${bookingId}`);
//   };

//   // Plain Read-Only Status Badges (No Animations/Buttons)
...
//       className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-semibold text-slate-700 bg-slate-50 hover:bg-slate-100 active:bg-slate-200 border border-slate-200 rounded-xl transition-all shadow-xs disabled:opacity-50 shrink-0"
//     >
...
//                 className="px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider text-white bg-amber-600 hover:bg-amber-700 active:bg-amber-800 transition-all shadow-xs flex items-center gap-1.5"
//               >
//                 <span>Pay Now</span>
