                ...
                {(showAllReviews ? reviewsList : reviewsList.slice(0, 5)).map(
                  (review: any, index: number) => {
                    ...
                    return (
                      <div
                        key={review.id || index}
                        className="p-3.5 sm:p-4 border border-slate-100 rounded-2xl bg-slate-50/40 space-y-1.5 w-full"
                      >
                        <div className="flex items-center justify-between">
                          {/* Sender Profile Link */}
                          <Link
                          ...
                          >
                            <div className="relative shrink-0">
                              {review.reviewer_profile_image || review.profile_image ? (
                                <Image
                                  ...
                                  width={36}
                                  height={36}
                                  className="w-9 h-9 rounded-full object-cover border border-white shadow-2xs group-hover:ring-2 group-hover:ring-amber-500 transition-all"
                                />
                              ) : (
                                <div className="w-9 h-9 rounded-full bg-slate-200 text-slate-700 font-black text-xs flex items-center justify-center group-hover:bg-amber-500 group-hover:text-white transition-all">
                            ...
                            <div>
                              <div className="flex items-center gap-1">
                                <h4 className="text-sm font-extrabold text-slate-900 group-hover:text-amber-600 transition-colors leading-none">
                                  {reviewerName}
                                </h4>
                                <User className="w-3 h-3 text-slate-400 group-hover:text-amber-500 transition-colors" />
                              </div>
                          ...
                          {/* Rating Display */}
                          <div className="flex text-amber-400 gap-0.5 bg-white px-2 py-0.5 rounded-full border border-slate-200/60 shadow-2xs shrink-0">
